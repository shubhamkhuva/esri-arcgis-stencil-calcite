import { A as ActiveRouter } from './active-router-b7ea6a26.js';
import './match-path-02f6df12.js';
import { B as BUILD, N as NAMESPACE } from './index-237c0fcb.js';
        ...
        if (BUILD.style && Cstr.style) {
            ...
            if (!styles.has(scopeId)) {
                ...
                if (!BUILD.hydrateServerSide &&
                    ...
                    style = await import('./shadow-css-e8c71897.js').then((m) => m.scopeCss(style, scopeId, false));
                }
